...
function SalesItemComponent({ index, item }: { index: number, item: TSaleListItem }) {
        ...
        <div className="grid grid-row-2 gap-1  p-2 rounded-md shadow-lg border">
            <div className="flex justify-between gap-1 flex-1 items-center">
                <div className="grid grid-cols-12 gap-2 items-center">
                    ...
                    <div className="col-span-3 text-sm italic">{item.customer}</div>
                    ...
                    <div className={clsx("col-span-2 text-xs muted text-center rounded-lg  py-1", (item.status === 'DUE') && 'bg-pink-700 text-white', (item.status === 'PAID') && 'bg-lime-700 text-white')}>{item.status}</div>
